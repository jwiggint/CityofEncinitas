...
package EncComponents.TOC.toc
{
	...
	public class TOC extends Tree
	{
	    ...
	    public function TOC(map:Map = null)
	    {
	        ...
	        itemRenderer = new ClassFactory(EncComponents.TOC.toc.tocClasses.TocItemRenderer);
	    ...
	    private function registerMapLayer(layer:Layer):void
	    {
	        ...
	        const tocItem:TocMapLayerItem = new TocMapLayerItem(layer,map, _labelFunction, _isMapServiceOnly, _excludeLayers, _showMetadataButton, _legendCollapsed);
