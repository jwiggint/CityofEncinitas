...
package EncComponents.TOC.toc.tocClasses
{
	...
	import EncComponents.TOC.DetailsWindow;
	import EncComponents.TOC.toc.controls.CheckBoxScaleDependant;
	...
	public class TocItemRenderer extends TreeItemRenderer
	{
		...
		[Embed(source="EncComponents/TOC/assets/images/metadata.png")]
		[Bindable]
		private var _Icon2:Class;
		
		[Embed(source="EncComponents/TOC/assets/images/plus.png")]
		[Bindable]
		private var _Expand:Class;
		
		[Embed(source="EncComponents/TOC/assets/images/minus.png")]
		[Bindable]
		...
		private function showMeta(evt:Event):void
		{
			if (data is TocItem) {
				...
				if(item.ttooltip && item.ttooltip != ""){
					...
					mydetailswindow =  DetailsWindow(PopUpManager.createPopUp(parentDocument.map,DetailsWindow,false,PopUpManagerChildList.POPUP));
